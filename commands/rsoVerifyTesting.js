...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("rso_membership_verify_test")
    .setDescription("Verifies that the ULID has a pending membership status")
  ...
  async execute(interaction, clientm) {
    ...
    let uri =`https://engage-api.campuslabs.com/api/v3.0/communities/useradditionalfields?userId.campusEmail=${ulid}%40ilstu.edu`;
